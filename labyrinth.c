...
void rec_find_thread(){
    ...
    */
    ...
    if(up){
        ...
        nb_direction--;
        if(nb_direction == 0 || get_first_room_for_new_thread() == NB_THREAD){ // simple recusivité à lancer dans le thread actuel si une seule direction ou si le nb max de thread est atteint
